...
contract MockCoordinatorV2 is ICoordinator {
    ...
    function initialize(BillingConfig calldata) external {}
    ...
    function cancelRequest(bytes32) external override {}

    function reportVerificationResult(uint64, uint32, address, bool) external override {}

    function prepareNextInterval(uint64, uint32, address) external override {}
}
