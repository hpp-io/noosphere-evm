...
///      `DelegateSubscription` from `signer` and submitting to `DelegateeCoordinator.sol.createSubscriptionDelegatee()`
/// @dev In theory, this could use EIP-1271 standard signature validation but that enables a contract client to override
